...
exports.metrics = {
  ...
  MC: { name: 'MC', regexp: /MC\:([\d\.]+)/i, value: '', unit: 'mc', graph: 1, mqtt: 1, graphOptions: { legendLbl: 'MC', lines: { lineWidth: 1, steps: true }, colors: ['#09c'],  /*yaxis: { ticks: [1,5,20], transform:  function(v) {return v==0?v:Math.log(v); //log scale },*/ tickDecimals: 2 } },
}
